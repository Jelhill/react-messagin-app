...
import { getUserInputs } from "../store/actions/userActions"
...
function Register() {
    ...
    function handleInputs (e) {
        const userInputs = {[e.target.name]: e.target.value}
        dispatch({
            type: "USER_FORM_INPUTS",
            value: userInputs
        })
    }
    ...
    function handleSubmit(e) {
        e.preventDefault();
        const { firstname, lastname, email, password } = state.userReducer.formDetails
    ...
    return (
        ...
        <div className="right-side">
            <div className="form-div">
                <form action="">
                    <div>
                        <input type="text" placeholder="First Name" name="firstname" id="firstname" onChange={handleInputs}/><br />
                        <input type="text" placeholder="Last Name" name="lastname" id="lastname" onChange={handleInputs}/><br />
                        <input type="email" placeholder="Email" name="email" id="email" onChange={handleInputs} />
                        <input type="password" placeholder="Password" name="password" id="password" onChange={handleInputs}/><br />
                    </div>

                    <button onClick={handleSubmit}>Sign Up</button>     
                    <button className="google-signIn" id="login">Sign up with Google</button>                      
                </form>
